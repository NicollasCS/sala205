/**
 * 🔐 Controllers de autenticação (login/cadastro)
 */
import crypto from 'crypto';
import { normalizeUser } from '../utils/helpers.js';

/**
 * POST /api/cadastro - Cadastro de novo usuário
 */
function handleCadastro(supabase, createLog) {
 ...
 */
function handleLogin(supabase, createLog) {
    return async (req, res) => {
        const { nome, senha } = req.body;
...
export { handleCadastro, handleLogin };
